...
namespace
{
	...
	BOOST_LOG_ATTRIBUTE_KEYWORD(severity	, "Severity"	, wotan::logger::type						)
...
namespace
{
	...
	#define LOG_DEBUG()     BOOST_LOG_STREAM_SEV(*wotan::logger::logger_, wotan::logger::Debug) \
		<< __FUNCTION__ << "(): "
	#define LOG_INFO()      BOOST_LOG_STREAM_SEV(*wotan::logger::logger_, wotan::logger::Info) \
		<< __FUNCTION__ << "(): "
	#define LOG_WARNING()   BOOST_LOG_STREAM_SEV(*wotan::logger::logger_, wotan::logger::Warning) \
		<< __FUNCTION__ << "(): "
	#define LOG_ERROR()     BOOST_LOG_STREAM_SEV(*wotan::logger::logger_, wotan::logger::Error) \
		<< __FUNCTION__ << "(): "
	#define LOG()           LOG_INFO()
}
